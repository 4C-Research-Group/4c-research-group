...
const sampleBlogs = [
  ...
  },
  {
    ...
    author_image_url:
      "https://images.unsplash.com/photo-1594824475544-3c2c1c0c0c0c?w=200&h=200&fit=crop&crop=face",
  },
  {
...
async function insertSampleBlogs() {
  try {
    console.log("Starting sample blog insertion...");
    ...
    console.log("Sample blog insertion completed successfully!");
    ...
    console.error("Unexpected error during blog insertion:", error);
  }
}
